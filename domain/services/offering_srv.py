...
from domain.entities.carrier_offering_ent import CarrierOfferingEntity
...
from domain.interfaces.i_offering_repo import IOfferingRepository
from domain.interfaces.i_carrier_offering_repo import ICarrierOfferingRepository
